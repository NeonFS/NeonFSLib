...
neonfs::security::AESEncryptionProvider::AESEncryptionProvider(secure_bytes &&master_key, const size_t poolMaxSize = 5): contextPool_(AESGCMCtxPool::create(poolMaxSize)), key_(master_key) {
